...
Previous_Gestational_Diabetes : Binary: 1 if individual had gestational diabetes previously (integer).''')
    ...
    st.write(' ### Q1 What is the relationship between BMI and fasting blood glucose levels?')
    ...
    st.write('### Q1 What is the relationship between BMI and HbA1c levels?')
    ...
    st.write(' ### Q2 Do individuals with a family history of diabetes show higher average HbA1c or glucose levels?')
    ...
    st.write(' ### Q3 Is there a significant difference in diabetes markers (like HbA1c) between males and females?')
    ...
    st.write('### Q4 How does physical activity level impact blood sugar levels or BMI?')
    ...
    st.write('### Q5 Are there differences in HBA1C levels among different ethnic groups?')
    ...
    st.write('### Q6 Is smoking status linked to higher LDL or lower HDL cholesterol?')
    ...
    st.write('### Q7 How does previous gestational diabetes affect current glucose control among females?')
